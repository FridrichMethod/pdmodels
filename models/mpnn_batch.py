...
class MPNNBatch:
    ...
    def score(
        ...
        if verbose:
            self._verbose_message(protein_dict)
...
def main(args):
    """Run the MPNN model for batch sampling and scoring."""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "pdb_path",
        type=str,
        help="The path to the PDB file containing the complex structure.",
    )
    parser.add_argument(
        "output_path",
        type=str,
    ...
    parser.add_argument(
        ...
        help="The type of the MPNN model.",
    )
    parser.add_argument(
        "--ligand_mpnn_use_side_chain_context",
        action="store_true",
        help="Whether to use side chain context for the LigandMPNN model.",
    )
    parser.add_argument(
        "--seed",
        type=int,
        default=None,
        help="The seed to set for reproducibility.",
    )
    parser.add_argument(
        "--seqs_list",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="A comma-separated list of chain letters of the redesign chains.",
    )
    parser.add_argument(
        "--redesigned_residues",
        type=str,
        default="",
        help="A space-separated list of chain letter and residue number pairs of the redesigned residues.",
    )
    parser.add_argument(
        "--symmetry_residues",
        type=str,
        default="",
        help="A pipe-separated list of comma-separated symmetry residues.",
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
        help="Whether to print the parsed ligand atoms and their types.",
    )
